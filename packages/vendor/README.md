...
`startVendor` uses the minimal `mountStory` adapter. It does not provide application chrome, themes, or the editable starter template. Most Vite applications should prefer compiled ESM; this package is for explicit source/IR loading workflows.
