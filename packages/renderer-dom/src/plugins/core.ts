...
export function coreDOM(): DOMPlugin {
  ...
  return {
    ...
    rules: [
      ...
      kindElementRule('bold', 'b', [metadata]),
      kindElementRule('italic', 'i', [metadata]),
      kindElementRule('strong', 'strong', [metadata]),
      kindElementRule('emphasis', 'em', [metadata]),
      kindElementRule('underline', 'u', [metadata]),
      kindElementRule('strike', 'del', [metadata]),
      kindElementRule('superscript', 'sup', [metadata]),
      kindElementRule('subscript', 'sub', [metadata]),
