...
`createSugarcastLowerings()` exposes trusted IR-lowering extensions. Portable source-defined `<<widget>>` declarations lower to lexical or file-wide view callables, while scripts, DOM macros and runtime `Macro.add` remain unsupported.
